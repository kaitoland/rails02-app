...
class CreatorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create creator" do
    assert_difference('Creator.count') do
      post creators_url, params: { creator: { name: @creator.name, registered_at: @creator.registered_at } }
    end
  ...
  test "should update creator" do
    patch creator_url(@creator), params: { creator: { name: @creator.name, registered_at: @creator.registered_at } }
